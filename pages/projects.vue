...
<script lang="ts">
import { Props as introductionProps } from "@/components/molecule/introduction.vue"

export default defineComponent({
  setup() {
    const introduction = ref<introductionProps>(
      {
        pageTitle: "<projects/>",
        ...
        imageSrc: "/image/projects/project-1.jpeg"
      }
    )
    return {
      introduction
